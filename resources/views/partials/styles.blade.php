<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Nota da tela: mora FORA do card (dentro dele a primeira letra era
     cortada pela borda, porque o card usa overflow: hidden). */
  .chat__nota { margin: 12px 2px 0; font-size: 12px; line-height: 1.5; color: var(--muted); }
